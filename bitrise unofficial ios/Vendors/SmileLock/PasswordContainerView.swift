...
open class PasswordContainerView: UIView {
  ...
  open class func create(withDigit digit: Int) -> PasswordContainerView {
    ...
    guard let v = view else {
      assertionFailure("Failed to initialise Password Container View from NIB file")
      return PasswordContainerView(frame: .zero)
    }
    return v
  }
  ...
  open func touchAuthentication() {
    ...
    touchIDContext.evaluatePolicy(.deviceOwnerAuthenticationWithBiometrics,
